...
<html lang="en">
    <head>
        ...
        <title>Kesalahan Server - Kana Tojong</title>
        <!-- Impor Font Poppins -->
    ...
    <body class="antialiased font-sans bg-background">
        <div class="min-h-screen flex flex-col items-center justify-center text-center px-4">
            ...
            <h2 class="text-3xl font-bold text-dark mt-4">Terjadi Kesalahan pada Server</h2>
            <p class="text-lg text-secondary mt-2 max-w-md">
                Maaf, terjadi masalah internal pada sistem kami. Tim kami telah diberitahu dan sedang menanganinya. Silakan coba lagi nanti.
            </p>
            <div class="mt-8">
