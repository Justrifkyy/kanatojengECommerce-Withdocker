...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Kana Tojong') }}</title>
    ...
    <body class="font-sans text-gray-900 antialiased">
        {{-- Latar belakang halaman kini menggunakan warna krem/beige --}}
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-surface">
            {{-- Logo ditempatkan di atas kartu form --}}
            <div class="mb-8">
                <a href="/">
            ...
            {{-- Kartu form dengan sudut membulat dan bayangan --}}
